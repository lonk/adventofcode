...
const computeNewBoxValue = (grid, box, neighbours) => {
  const activeNeighboursCount = neighbours.reduce(
    (acc, neighbour) => (grid.get(neighbour) === "#" ? acc + 1 : acc),
    0
  );
